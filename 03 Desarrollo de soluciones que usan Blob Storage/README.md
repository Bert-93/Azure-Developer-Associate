...
Si quieres, puedo:
- Añadir ejemplos de JSON para una `management policy` (reglas lifecycle).
- Incluir snippets más detallados para SDKs (Python/.NET/JS).
- Crear un pequeño script de ejemplo para subir/limpiar blobs en CI.
